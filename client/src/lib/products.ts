...
export const products: Product[] = [
  {
    ...
    productImage: `${storageBase}/product_book_spiritual_e94d56b8.png`,
    features: [
      "手繪水彩風格插畫，每一幅都蘊含療癒能量",
      "結合心理學與靈性智慧的故事敘事",
      "適合獨處時的自我對話與反思",
  ...
  },
  {
    ...
    productImage: `${storageBase}/product_autobiography_3bf3ec48.png`,
    features: [
  ...
  },
  {
    ...
    productImage: `${storageBase}/product_oracle_cards_745741fc.png`,
    features: [
  ...
  },
  {
    ...
    productImage: `${storageBase}/product_qimen_cards_f0c75602.png`,
    features: [
